...
// teamWaveApiRequest('api/projects', 'GET').then(t=>console.log(t))
// teamWaveApiRequest(`api/projects/11699/taskgroups`, 'GET').then(t=>console.log(t))
// teamWaveApiRequest(`api/projects/11699/taskgroups`, 'GET', { page: 1 }).then(t=>console.log(t))
// teamWaveApiRequest(`api/projects/11699/taskgroups`, 'GET', { page: 2 }).then(t=>console.log(t))
// teamWaveApiRequest(`api/projects/11699/taskgroups`, 'GET', { page: 3 }).then(t=>console.log(t))

// a1=teamWaveApiRequest(`api/projects/11699/taskgroups`, 'GET', { page: 1 })
// a2=teamWaveApiRequest(`api/projects/11699/taskgroups`, 'GET', { page: 2 })
// a3=teamWaveApiRequest(`api/projects/11699/taskgroups`, 'GET', { page: 3 })
// Promise.all([a1,a2,a3]).then(values=>console.log(values))
// var tgl;
// teamWaveApiRequest(`api/projects/11699/taskgroups`, 'GET').then(t=>{tgl = t;})
